...
const HeroSection = () =>{
    return (
    <section id="home" className="bg-background py-8 px-6 border-t border-border">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mt-10">
            <button className="bg-primary hover:bg-primary-hover text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 flex items-center justify-center gap-2">
